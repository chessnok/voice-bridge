...
def _instructions() -> str:
    ...
    return (
        ...
        "Перед НЕОБРАТИМЫМ действием (отправка письма/сообщения, удаление файла) назови, "
        "что именно произойдёт, и дождись подтверждения. Для обратимого подтверждения не нужны.\n"
